      ...
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        >
          <ul className="flex flex-col lg:flex-row list-none lg:ml-auto mt-2 lg:mt-0">
            ...
            <li className="nav-item">
              <Link to="/logout" className='px-3 py-1 flex items-center leading-snug text-white hover:opacity-75'>
                <span className="block pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-700 md:p-0">Logout</span>
              </Link>
            </li>
            <li className="nav-item">
              <span className='px-3 py-1 flex items-center leading-snug text-white'>
                <span className="block pl-3 pr-4 text-gray-900 rounded">Hi, {firstname}
                </span>
              </span>
            </li>
          </ul>
